    ...
    if (options && typeof options === 'object' && !Array.isArray(options)) {
        Object.keys(options).forEach(function (optionName) {
            ...
            if (matchedConfigOption &&
                ...
                throw new Error('Invalid configuration option "' + optionName + '"');
            }
        });
    }
...
AutoTyper.prototype = {
    init: function () {
        ...
        if (!this.stringsToType || !Array.isArray(this.stringsToType) || !this.stringsToType.length) {
            throw new Error('Target element must have a "data-typing-widget-text" attribute containing an array of strings');
        }
